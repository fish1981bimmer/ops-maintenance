...
```
# 直接添加多个 IP
/ops-maintenance batch-add server1 server2 server3

# 带端口
/ops-maintenance batch-add server1:2222 server2:22

# 带用户
/ops-maintenance batch-add root@server1 admin@server2
